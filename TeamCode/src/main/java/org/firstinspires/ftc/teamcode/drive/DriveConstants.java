 ...
 *
 * DONE: Tune or adjust the following constants to fit your robot. Note that the non-final
...
public class DriveConstants {
    ...
    public static final double TICKS_PER_REV = DriveData.currentInstance.getTicksPerRev();
    public static final double MAX_RPM = DriveData.currentInstance.getMaxRPM();
     ...
     */
    public static double WHEEL_RADIUS = DriveData.currentInstance.getWheelRadius(); // in
    public static double GEAR_RATIO = DriveData.currentInstance.getGearRatio(); // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = DriveData.currentInstance.getTrackWidth(); // in
...
//    public static double kStatic = 0.006;
     ...
     * Resulting in 60.52801845916335 in/s.
    ...
    public static double MAX_ACCEL = DriveData.currentInstance.getMaxAccel();

    // public static double MAX_ANG_VEL = 9.345771024505504; // from MaxAngVeloTuner testing // Math.toRadians(247.7142857142857);
//    public static double MAX_ANG_VEL = Math.toRadians(247.7142857142857);
    public static double MAX_ANG_VEL = DriveData.currentInstance.getMaxAngVel();
    public static double MAX_ANG_ACCEL = DriveData.currentInstance.getMaxAngAccel();
